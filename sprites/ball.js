$(function () {
    ...
    var drawBall = function (ball) {
        ...
        radialGradient = renderingContext.createRadialGradient(ball.gradient.x0, ball.gradient.y0, ball.gradient.r0, ball.gradient.x1, ball.gradient.y1, ball.gradient.r1);
